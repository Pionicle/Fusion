...
from src.routes.api.reader import router as reader_router
...
# Добавление роутера читателей под префиксом /readers с тегом "Readers"
router.include_router(reader_router, prefix="/readers", tags=["Читатели"])
